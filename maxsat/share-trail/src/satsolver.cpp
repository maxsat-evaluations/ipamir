...
#ifdef GLUCOSE41
#include "solvers/glucose-syrup-4.1/glucose41_solver.h"
#endif

#define NAME_GLUCOSE3 "glucose3"
#define NAME_GLUCOSE3X "glucose3x"
#define NAME_GLUCOSE41 "glucose41"
...
#endif
#ifdef GLUCOSE41
  solvers_available.push_back(NAME_GLUCOSE41);
#endif
#ifdef GLUCOSE3
...
#ifdef GLUCOSE41
  return NAME_GLUCOSE41;
#elif defined(GLUCOSE3)
...
#ifdef GLUCOSE41
  if (name==NAME_GLUCOSE41) {
    Glucose41Solver* solver = new Glucose41Solver();
    return (SATsolver*)solver;
  }
#endif
...
string cgss2::satsolver_version(string name, int l) {
  ...
  #ifdef GLUCOSE41
    if (name==NAME_GLUCOSE41) {
      return Glucose41Solver::version(l);
    }
  #endif
