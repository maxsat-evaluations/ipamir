...
static inline TotTree* itot_build_parent(TotTree* l, TotTree* r, ClauseSet& dest, unsigned rhs, int& top)
{
...
//
//=============================================================================
inline TotTree *itot_new(ClauseSet& dest, vector<int>& lhs, unsigned rhs, int& top)
{
	unsigned n = lhs.size();
	...
	while (nqueue.size() > 1) {
		...
		nqueue.pop_front();
		nqueue.push_back(itot_build_parent(l, r, dest, rhs, top));
	}
...
//
//=============================================================================
inline void itot_increase(TotTree *tree, ClauseSet& dest, unsigned rhs, int& top)
{
