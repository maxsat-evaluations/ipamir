...
#warning \
    "Unknown compiler. Not adding visibility information to IPAMIR symbols."
 ...
 *
 * If 'lit' has already been declared as a soft literal, this function changes
 * the weight of 'lit' to 'weight'.
 *
 * Required state: INPUT or OPTIMAL or SAT or UNSAT
 * State after: INPUT
 */
 ...
 *     having the value passed in the ipamir_set_terminate function (2nd
 * parameter).
 *
 * Required state: INPUT or OPTIMAL or SAT or UNSAT
 * State after: INPUT or OPTIMAL or SAT or UNSAT (unchanged)
 */
IPAMIR_API void ipamir_set_terminate(void* solver, void* state,
