...
- `ApertureCaDiCraig::A_LOCAL`
- `ApertureCaDiCraig::B_LOCAL`
- `ApertureCaDiCraig::GLOBAL`

Label clauses via `label_clause` and the following types:

- `ApertureCaDiCraig::A_CLAUSE`
- `ApertureCaDiCraig::B_CLAUSE`
...
- `ApertureCaDiCraig::SYMMETRIC`
- `ApertureCaDiCraig::ASYMMETRIC`
- `ApertureCaDiCraig::DUAL_SYMMETRIC`
- `ApertureCaDiCraig::DUAL_ASYMMETRIC`
...
- `ApertureCaDiCraig::NONE`
- `ApertureCaDiCraig::SYMMETRIC` (requires partial interpolant SYMMETRIC)
- `ApertureCaDiCraig::ASYMMETRIC` (requires partial interpolant ASYMMETRIC)
- `ApertureCaDiCraig::DUAL_SYMMETRIC` (requires partial interpolant DUAL_SYMMETRIC)
- `ApertureCaDiCraig::DUAL_ASYMMETRIC` (requires partial interpolant DUAL_ASYMMETRIC)
- `ApertureCaDiCraig::INTERSECTION` (of selected partial interpolants)
- `ApertureCaDiCraig::UNION` (of selected partial interpolants)
- `ApertureCaDiCraig::SMALLEST` (of selected partial interpolants)
- `ApertureCaDiCraig::LARGEST` (of selected partial interpolants)
...
- `ApertureCaDiCraig::NONE`
- `ApertureCaDiCraig::CONSTANT0` (CNF is constant false)
- `ApertureCaDiCraig::CONSTANT1` (CNF is constant true)
- `ApertureCaDiCraig::NORMAL` (CNF is not constant)
...
if (solver.solve () == ApertureCaDiCaL::Status::UNSATISFIABLE) {
  ...
  ApertureCaDiCraig::CraigCnfType result = tracer.create_craig_interpolant (
    ApertureCaDiCraig::CraigInterpolant::ASYMMETRIC, interpolant, end_variable);
...
tracer.set_craig_construction (
  ...
  | ApertureCaDiCraig::CraigConstruction::DUAL_ASYMMETRIC);
...
if (solver.solve () == ApertureCaDiCaL::Status::UNSATISFIABLE) {
  ...
  tracer.create_craig_interpolant (
    ApertureCaDiCraig::CraigInterpolant::ASYMMETRIC, cnf_asym, ...);

  std::vector<std::vector<int>> cnf_dual;
  tracer.create_craig_interpolant (
    ApertureCaDiCraig::CraigInterpolant::DUAL_ASYMMETRIC, cnf_dual, ...);

  std::vector<std::vector<int>> cnf_union;
  tracer.create_craig_interpolant (
    ApertureCaDiCraig::CraigInterpolant::UNION, cnf_union, ...);

  std::vector<std::vector<int>> cnf_interst;
  tracer.create_craig_interpolant (
    ApertureCaDiCraig::CraigInterpolant::INTERSECTION, cnf_interst, ...);
}
...
tracer.label_variable (2, ApertureCaDiCraig::CraigVarType::GLOBAL);
solver.assume (-1);
solver.assume (2);

tracer.label_constraint (ApertureCaDiCraig::CraigClauseType::A_CLAUSE);
solver.constrain (1);
solver.constrain (-2);
solver.constrain (0);
