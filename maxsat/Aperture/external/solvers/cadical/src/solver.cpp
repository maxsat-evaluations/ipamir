...
void Solver::build (FILE *file, const char *prefix) {
  ...
  const char *v = ApertureCaDiCaL::version ();
...
const char *Solver::version () { return ApertureCaDiCaL::version (); }

const char *Solver::signature () { return ApertureCaDiCaL::signature (); }
