...
void kissat_set_polarity (kissat *solver, int lit);
void kissat_clear_polarity (kissat *solver, int lit);
void kissat_freeze_variable (kissat *solver, int lit);
void kissat_melt_variable (kissat *solver, int lit);
